        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('dashboard/artikel/update') ?>" method="POST" enctype="multipart/form-data">
                            <input type="hidden" value="<?= $dataArtikel['id'] ?>" name="id">
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Judul</label>
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" value="<?= $dataArtikel['judul'] ?>" name="judul" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Konten</label>
                                <div class="col-sm-12 col-md-7">
                                    <textarea name="konten" class="summernote-simple"><?= $dataArtikel['isi'] ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    ...
                                    <!-- gambar sebelumnya -->
                                    <img src="<?= base_url('uploads/artikel/' . $dataArtikel['gambar']) ?>" class="mt-3" alt="" width="200">
                                    <input type="hidden" name="image_old" value="<?= $dataArtikel['gambar'] ?>">
                                    <p class="text-muted">Gambar Sebelumnya</p>
                                </div>
